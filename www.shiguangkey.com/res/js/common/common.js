$(function () {
  //不同环境切换认证中心域名
  if (
    location.hostname == "www.shiguangkey.com" ||
    location.hostname == "shiguangkey.com"
  ) {
    //prod
    window.authUrl = "//auth2.shiguangkey.com/api";
  } else if (location.hostname == "www-pre.shiguangkey.com") {
    //test
    window.authUrl = "//auth2-pre.shiguangkey.com/api";
  } else if (location.hostname == "www-git-test.shiguangkey.com") {
    //test
    window.authUrl = "//auth2-git-test.shiguangkey.com/api";
  } else if (location.hostname == "www-git-dev.shiguangkey.com") {
    //dev
